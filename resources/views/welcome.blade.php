...
<div class="flex justify-between m-6">
    <div class="flex flex-col h-full max-w-lg mx-auto bg-gray-800 rounded-lg">
            ...
            <div class="py-2 px-4">
              ...
              >
                <a href="blog/detail">El equipo de Artisoft bien descansado</a>
              </h1>
            </div>
            <div class="px-4 space-y-2">

                <p class="text-gray-400 font-normal leading-5 tracking-wide">Nunca fallla</p>
                <p class="text-gray-400 font-normal leading-5 tracking-wide">Nunca toma</p>
                <p class="text-gray-400 font-normal leading-5 tracking-wide">Nunca nada</p>
